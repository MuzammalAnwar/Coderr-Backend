...
class OfferReadSerializer(serializers.ModelSerializer):
    ...
    - details = [{id, url}]
    - min_price and min_delivery_time as integers
    """
    user = serializers.IntegerField(source="business_user_id", read_only=True)
    details = serializers.SerializerMethodField()
    min_price = serializers.DecimalField(
...
class OfferReadWithDetailsSerializer(serializers.ModelSerializer):
    ...
    - details as full JSON
    - includes min_price as integers and min_delivery_time as integers also
    - includes user, which is the business_user_id
    """
    user = serializers.IntegerField(source="business_user_id", read_only=True)
